...
MODE_ICONEN: dict[str, str] = {
    ...
    "stad": (
        poly([(38, 32), (38, 22), (44, 22), (44, 28), (48, 28), (48, 22),
              (52, 22), (52, 28), (56, 28), (56, 22), (62, 22), (62, 32),
              (62, 54), (38, 54)])
        + poly([(10, 54), (10, 44), (16, 44), (16, 50), (22, 50), (22, 44),
                (28, 44), (28, 50), (34, 50), (34, 44), (40, 44), (40, 54),
                (60, 54), (60, 44), (66, 44), (66, 50), (72, 50), (72, 44),
                (78, 44), (78, 50), (84, 50), (84, 44), (90, 44), (90, 54),
                (90, 92), (10, 92)])
        + poly([(42, 92), (42, 74), (50, 64), (58, 74), (58, 92)], hole=True)
        + poly([(19, 64), (27, 64), (27, 74), (19, 74)], hole=True)
        + poly([(73, 64), (81, 64), (81, 74), (73, 74)], hole=True)
    ),
}
