...
struct Arena {
    ...
    static let all: [Arena] = [
        Arena(
            name: L3("Het Orkenrijk", "The Orc Realm", "Le Royaume des Orques"),
        ...
        Arena(
            name: L3("De Oorlogshorde", "The War Horde", "La Horde de Guerre"),
        ...
        Arena(
            name: L3("De Spinnenkuil", "The Spider Pit", "La Fosse aux Araignées"),
        ...
        Arena(
            name: L3("De Bottenburcht", "The Bone Fortress", "La Forteresse d'Os"),
        ...
        Arena(
            name: L3("Het Trollenmoeras", "The Troll Mire", "Le Marais des Trolls"),
        ...
        Arena(
            name: L3("Pluizige Pussy", "The Fluffy Kittens", "Les Chatons Pelucheux"),
        ...
        Arena(
            name: L3("De Zielenmist", "The Soul Mist", "La Brume des Âmes"),
        ...
        Arena(
            name: L3("De Bloedkathedraal", "The Blood Cathedral", "La Cathédrale de Sang"),
        ...
        Arena(
            name: L3("Het Grote Wolvenwoud", "The Great Wolf Forest", "La Grande Forêt des Loups"),
        ...
        Arena(
            name: L3("De Golemgroeve", "The Golem Quarry", "La Carrière des Golems"),
        ...
        Arena(
            name: L3("De Demonenpoort", "The Demon Gate", "La Porte des Démons"),
        ...
        Arena(
            name: L3("De IJsreuzenburcht", "The Frost Giants' Keep", "Le Donjon des Géants de Glace"),
        ...
        Arena(
            name: L3("Het Duivelsdiep", "The Devil's Deep", "L'Abîme du Diable"),
        ...
        Arena(
            name: L3("De Bliksemtoren", "The Lightning Tower", "La Tour de Foudre"),
        ...
        Arena(
            name: L3("De Slangentempel", "The Serpent Temple", "Le Temple des Serpents"),
        ...
        Arena(
            name: L3("Het Drakennest", "The Dragon Nest", "Le Nid des Dragons"),
        ...
        Arena(
            name: L3("Het Titanengraf", "The Titan Grave", "Le Tombeau des Titans"),
        ...
        Arena(
            name: L3("Het Rijk der Verdoemden", "The Realm of the Damned", "Le Royaume des Damnés"),
        ...
        Arena(
            name: L3("De Val der Engelen", "The Fall of Angels", "La Chute des Anges"),
        ...
        Arena(
            name: L3("De Sterrensmidse", "The Star Forge", "La Forge des Étoiles"),
        ...
        Arena(
            name: L3("Het Naamloze Diep", "The Nameless Deep", "Le Gouffre sans Nom"),
