...
enum Strings {
    private static let table: [String: [String]] = [
        ...
        "hint_searching": ["Zoekt je hoofd… zorg dat je zijwaarts in beeld ligt", "Looking for your head… make sure you are in view from the side", "Recherche de ta tête… place-toi de profil dans le cadre"],
        ...
        "tip_setup": ["Zet je telefoon rechtop naast je op de grond, zodat de camera je van opzij ziet.", "Stand your phone upright next to you on the floor, so the camera sees you from the side.", "Pose ton téléphone debout à côté de toi, pour que la caméra te voie de profil."],
        ...
        "tour5_tekst": ["In de arena vecht je je door twintig werelden. In het duel neem je het zestig seconden op tegen een tegenstander, online tegen een echte speler, en in de clicker bouw je met je push-ups een imperium.", "In the arena you fight through twenty worlds. In the duel you race an opponent for sixty seconds, online you race a real player, and in the clicker you build an empire out of your push-ups.", "Dans l'arène tu traverses vingt mondes. En duel tu affrontes un adversaire pendant soixante secondes, en ligne un vrai joueur, et dans le clicker tu bâtis un empire avec tes pompes."],
