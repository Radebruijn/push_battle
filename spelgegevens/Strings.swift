...
enum Strings {
    private static let table: [String: [String]] = [
        ...
        "stad_log_kop": ["Logboek", "Log", "Journal"],
        "stad_log_leeg": ["Nog niemand heeft je stad aangevallen.", "No one has attacked your city yet.", "Personne n'a encore attaqué ta cité."],
        ...
        "ov_start": ["Begin de overval — 60 seconden", "Start the raid — 60 seconds", "Lance le pillage — 60 secondes"],
